...
use App\Repository\TipologiaOspitalitaRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TipologiaOspitalitaRepository::class)]
class TipologiaOspitalita
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: Prenotazione::class, mappedBy: 'fkTipologiaOspitalita', orphanRemoval: true)]
    ...
    public function addPrenotazioni(Prenotazione $prenotazioni): static
    {
        if (!$this->Prenotazioni->contains($prenotazioni)) {
            ...
            $prenotazioni->setFkTipologiaOspitalita($this);
        }
    ...
    public function removePrenotazioni(Prenotazione $prenotazioni): static
    {
        if ($this->Prenotazioni->removeElement($prenotazioni)) {
            ...
            if ($prenotazioni->getFkTipologiaOspitalita() === $this) {
                $prenotazioni->setFkTipologiaOspitalita(null);
            }
        }
