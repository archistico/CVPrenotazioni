...
use App\Repository\TariffaRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TariffaRepository::class)]
class Tariffa
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Prenotazione::class, mappedBy: 'fkTariffa', orphanRemoval: true)]
    ...
    public function addPrenotazioni(Prenotazione $prenotazioni): static
    {
        if (!$this->Prenotazioni->contains($prenotazioni)) {
            ...
            $prenotazioni->setFkTariffa($this);
        }
    ...
    public function removePrenotazioni(Prenotazione $prenotazioni): static
    {
        if ($this->Prenotazioni->removeElement($prenotazioni)) {
            ...
            if ($prenotazioni->getFkTariffa() === $this) {
                $prenotazioni->setFkTariffa(null);
            }
        }
