...
use App\Repository\AlbergoRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AlbergoRepository::class)]
class Albergo
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Prenotazione::class, mappedBy: 'fkAlbergo', orphanRemoval: true)]
    ...
    public function addPrenotazioni(Prenotazione $prenotazioni): static
    {
        if (!$this->Prenotazioni->contains($prenotazioni)) {
            ...
            $prenotazioni->setFkAlbergo($this);
        }
    ...
    public function removePrenotazioni(Prenotazione $prenotazioni): static
    {
        if ($this->Prenotazioni->removeElement($prenotazioni)) {
            ...
            if ($prenotazioni->getFkAlbergo() === $this) {
                $prenotazioni->setFkAlbergo(null);
            }
        }
